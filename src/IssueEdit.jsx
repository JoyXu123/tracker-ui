...
import { Col, Panel, Form, FormGroup, FormControl, ControlLabel, ButtonToolbar, Button, Alert } from 'react-bootstrap';
...
class IssueEdit extends React.Component {
  ...
  async handleSubmit(e) {
    ...
    if (data) {
      ...
      showSuccess('Update issue successfully'); // eslint-disable-line no-alert
    }
  }
  ...
  render() {
    ...
    if (id == null) { /* we use double equals to match anything looks like a null*/
      if (propsId != null) {
          ...
          <Form horizontal onSubmit={this.handleSubmit}>
            ...
            <FormGroup>
              ...
              <FormGroup validationState={ invalidFields.due ? 'error' : null }>
                ...
                <Col sm={9}>
                  <FormControl componentClass={DateInput} name="due" value={due} 
                  onValidityChange={this.onValidityChange} onChange={this.onChange} key={id} />
            ...
            <FormGroup>
              ...
              <Col sm={9}>
                <FormControl componentClass={TextInput} tag="textarea" rows={4} cols={50} name="description" value={description}
